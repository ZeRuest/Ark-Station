/obj/machinery/power/generator_inverted
...
/obj/machinery/power/generator_inverted/New()
	..()
...
/obj/machinery/power/generator_inverted/proc/reconnect()
	circ1 = null
	circ2 = null
	if(src.loc && anchored)
		if(src.dir & (EAST|WEST))
			...
			if(circ1 && circ2 && (circ1.dir != WEST || circ2.dir != EAST))
				circ1 = null
				circ2 = null

/obj/machinery/power/generator_inverted/on_update_icon()
...
/obj/machinery/power/generator_inverted/Process()
...
/obj/machinery/power/generator_inverted/attack_ai(mob/user)
	attack_hand(user)

/obj/machinery/power/generator_inverted/attackby(obj/item/weapon/W as obj, mob/user as mob)
	if(isWrench(W))
...
/obj/machinery/power/generator_inverted/attack_hand(mob/user)
...
/obj/machinery/power/generator_inverted/ui_interact(mob/user, ui_key = "main", var/datum/nanoui/ui = null, var/force_open = 1)
...
/obj/machinery/power/generator_inverted/verb/rotate_clock()
	set category = "Object"
...
/obj/machinery/power/generator_inverted/verb/rotate_anticlock()
	set category = "Object"
