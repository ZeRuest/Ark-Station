...
/obj/item/weapon/book/manual/reactor
	...
	* - ќѕј—Ќќ—“№ —»Ћ№Ќќ√ќ ѕќ“ќ ј ¬ќ«ƒ”’ј ѕ–» ќ“ –џ“»» ¬Ќ”“–≈ЌЌ»’ Ћё ќ¬ ј “»¬Ќќ… «ќЌџ
	...
	ѕри управлении реактором необходимо учитывать, что скорость движени€ контрольных стержней ограничена. ѕолный выход стержней в активную зону (0-4м) занимает 80 секунд. “аким образом, управление
	достаточно инертно. ≈сли не среагировать воврем€ при всплеске реактивности, то GCR-H 1000 может выйти на необратимое увеличение реактивности топливных элементов с последующим перегревом, расплавлением
