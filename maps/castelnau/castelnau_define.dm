...
/datum/map/castelnau/get_map_info()
	. = list()
	. +=  "Вы находитесь на борту <b>[station_name]</b>, мультизадачного орбитального буксира класса Таурус. Между капитаном этого судна и независимой группой учённых был заключён контракт о буксировке и обеспечении научного шаттла Прометей с целью исследовани&#255; последними глубокого космоса в своих интересах."
	. +=  "Охрана судна укомплектована как сотрудниками, нан&#255;тыми капитаном лично, так и служащими частных военных компаний."
	return rhtml_decode(jointext(., "<br>"))
...
/datum/map/castelnau/send_welcome()
	...
	var/obj/effect/overmap/castelnau = map_sectors["1"]
