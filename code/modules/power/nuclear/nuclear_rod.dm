...
/obj/machinery/power/nuclear_rod/attackby(var/obj/item/weapon/nuclearfuel/F, var/mob/user)  //������ �������� ������
	if(!reactants && rodtemp < 1000)
		playsound(src.loc, 'sound/machines/click.ogg', 50, 1)
		reactants = F.reactants
		qdel(F)

/obj/machinery/power/nuclear_rod/attack_hand(mob/user)   //�������� ��������
...
/obj/machinery/power/nuclear_rod/attackby(obj/item/weapon/W, mob/user)  // ��� � ��� ������� �� �����������
	if(rodtemp < 2000)
		if(!broken)
...
/obj/machinery/power/nuclear_rod/proc/check_state()   // ����� �� ������ � �������
	if (rodtemp > 4000)
...
/obj/machinery/power/nuclear_rod/Process()     // ��������� � ������ ������ (� ����� �������, ������ �������) + �����
	React()
...
/obj/machinery/power/nuclear_rod/setupexample  //��� ������
	rodtemp = 2000
	anchored = 1
	accepted_rads = 200
