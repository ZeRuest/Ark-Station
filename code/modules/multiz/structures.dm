...
/obj/structure/ladder/proc/getTargetLadder(var/mob/M)
	if((!target_up && !target_down) || (target_up && !istype(target_up.loc, /turf/space)) || (target_up && !istype(target_up.loc, /turf/simulated/open))  (target_down && !istype(target_down.loc, /turf)))
