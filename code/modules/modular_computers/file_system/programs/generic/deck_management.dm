...
/datum/nano_module/deck_management
	...
	var/default_access = list(access_cargo, access_bridge, access_castelnau_bridge, access_castelnau_qm)  //The format is (needs one of list(these access constants or lists of access constants))
